...
```
 Developed by: Vaishnavi T RegisterNumber:25015144
...
**RESULTS**
Thus,the implementation of SR flipflop using verilog and validating their functionality using their functional tables.
